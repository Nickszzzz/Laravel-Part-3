                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                 <a href="/"><img src="{{ asset('ui/images/logo-w.png') }}" alt="" class="img-fluid bg-dark p-4 mx-auto d-block"></a>
                                ...
                                <form class="mt-5 mb-5 login-input"  method="POST" action="{{ route('register') }}">
                                    ...
                                    <button class="btn btn-dark login-form__btn submit w-100 text-light">Register</button>
                                </form>
                                <p class="mt-5 login-form__footer">Already have an account? <a href="{{route('login')}}" class="text-primary">Login</a> now</p>
                            </div>
                        </div>
                    </div>
                </div>
