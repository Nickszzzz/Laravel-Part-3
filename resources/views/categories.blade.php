                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f1.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f2.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f8.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                                    class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f3.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                                    class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">The best soft chocolate chip
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f4.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                                    class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">How to Make the Best Baked
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f5.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                                    class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">5 ingredient cilantro vinaigrette</a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f6.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                                    class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">5 ingredient cilantro vinaigrette</a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <article class="post-grid mb-5">
                                <div class="post-thumb mb-4">
                                    <img src="{{ asset('ui/images/news/f7.jpg') }}" alt="" class="img-fluid w-100">
                                </div>
                                <span
                                    class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">The best soft chocolate chip
                        ...
                        <div class="sidebar-wrap mt-5 mt-lg-0">
                            <div class="sidebar-widget about mb-5 text-center p-3">
                                <div class="about-author">
                                    <img src="{{ asset('ui/images/author.jpg') }}" alt="" class="img-fluid">
                                </div>
                                ...
                                <img src="{{ asset('ui/images/liammason.png') }}" alt="" class="img-fluid">
                            </div>
                            ...
                            <div class="sidebar-widget mb-5 ">
                                ...
                                <div class="sidebar-post-item-big">
                                    <a href="blog-single.html"><img src="{{ asset('ui/images/news/img-1.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="media border-bottom py-3 sidebar-post-item">
                                    <a href="#"><img class="mr-4" src="{{ asset('ui/images/news/thumb-1.jpg') }}"
                                            alt=""></a>
                                ...
                                <div class="media py-3 sidebar-post-item">
                                    <a href="#"><img class="mr-4" src="{{ asset('ui/images/news/thumb-2.jpg') }}"
                                            alt=""></a>
                                    <div class="media-body">
                                        <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                            2019</span>
                            ...
                            <div class="sidebar-widget sidebar-adv mb-5">
                                <a href="#"><img src="{{ asset('ui/images/sidebar-banner3.png') }}" alt=""
