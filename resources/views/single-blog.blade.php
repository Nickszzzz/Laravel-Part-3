                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <div class="single-post">
                        <div class="post-header mb-5 text-center">
                            ...
                            <div class="post-featured-image mt-5">
                                <img src="{{ asset('ui/images/fashion/bg-banner.jpg') }}" class="img-fluid w-100" alt="featured-image">
                            </div>
                        </div>
                        <div class="post-body">
                            <div class="entry-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <img src="{{ asset('ui/images/fashion/single-img1.png') }}" alt="post-ads"
                                            class="img-fluid mr-4 w-100">
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <img src="{{ asset('ui/images/fashion/single-img2.png') }}" alt="post-ads"
                                            class="img-fluid mr-4 w-100">
                                    </div>
                                </div>
                    ...
                    <div class="post-author d-flex my-5">
                        <div class="author-img">
                            <img alt="" src="{{ asset('ui/images/author.jpg') }}" class="avatar avatar-100 photo" width="100"
                                height="100">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="post-block-wrapper mb-4 mb-lg-0">
                                    <a href="blog-single.html">
                                        <img class="img-fluid" src="{{ asset('ui/images/fashion/img-1.jpg') }}" alt="post-thumbnail" />
                                    </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="post-block-wrapper mb-4 mb-lg-0">
                                    <a href="blog-single.html">
                                        <img class="img-fluid" src="{{ asset('ui/images/fashion/img-2.jpg') }}" alt="post-thumbnail" />
                                    </a>
                                    <div class="post-content mt-3">
                                        <h5>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="post-block-wrapper">
                                    <a href="blog-single.html">
                                        <img class="img-fluid" src="{{ asset('ui/images/fashion/img-3.jpg') }}" alt="post-thumbnail" />
                                    </a>
                                    <div class="post-content mt-3">
                                        <h5>
                    ...
                    <div class="comment-area my-5">
                        ...
                        <div class="comment-area-box media">
                            <img alt="" src="{{ asset('ui/images/blog-user-2.jpg') }}" class="img-fluid float-left mr-3 mt-2">
                        ...
                        <div class="comment-area-box media mt-5">
                            <img alt="" src="{{ asset('ui/images/blog-user-3.jpg') }}" class="mt-2 img-fluid float-left mr-3">
